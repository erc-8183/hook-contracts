...
contract ERC8001Test is Test {
    ...
    function test_ProposeCoordination_Success() public {
        ...
        IERC8001.AgentIntent memory intent =
            _createAgentIntent(payloadHash, expiry, nonce, coordinationType, coordinationValue);
    ...
    function test_ProposeCoordination_Revert_ExpiredIntent() public {
        ...
        IERC8001.AgentIntent memory intent = _createAgentIntent(payloadHash, expiry, nonce, coordinationType, 0);
    ...
    function test_AcceptCoordination_Success() public {
        ...
        IERC8001.AcceptanceAttestation memory attestation =
            _createAcceptanceAttestation(intentHash, participant1, 1, uint64(block.timestamp + 30 minutes), bytes32(0));
    ...
    function test_AcceptCoordination_AllAccepted() public {
        ...
        for (uint256 i = 0; i < participants.length; i++) {
            ...
            IERC8001.AcceptanceAttestation memory attestation = _createAcceptanceAttestation(
                intentHash, participant, 1, uint64(block.timestamp + 30 minutes), bytes32(0)
            );
    ...
    function test_AcceptCoordination_Revert_NotParticipant() public {
        ...
        IERC8001.AcceptanceAttestation memory attestation = _createAcceptanceAttestation(
            intentHash, nonParticipant, 1, uint64(block.timestamp + 30 minutes), bytes32(0)
        );
    ...
    function test_GetIntentHash() public {
        IERC8001.AgentIntent memory intent =
            _createAgentIntent(keccak256("payload"), uint64(block.timestamp + 1 hours), 1, keccak256("TEST"), 1000);
