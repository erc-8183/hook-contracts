...
contract ERC8001CoordinationHookTest is Test {
    ...
    function test_ProposeCoordination_Success() public {
        ...
        vm.prank(client);
        bytes32 intentHash = hook.proposeCoordination(
            jobId,
            intent,
            signature,
            payload,
            ERC8001CoordinationHook.ActionType.Complete
        );
    ...
    function test_AcceptCoordination_Success() public {
        ...
        uint256 jobId = 1;
        (, ERC8001CoordinationHook.ActionType actionType, bytes32 intentHash) = 
            hook.getJobCoordination(jobId);
    ...
    function test_PreReject_AllowsWhenCoordinationReady() public {
        ...
        hook.proposeCoordination(
            ...
            signature,
            payload,
            ERC8001CoordinationHook.ActionType.Reject
        );
